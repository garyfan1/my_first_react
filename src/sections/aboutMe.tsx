...
const AboutMe = forwardRef<HTMLDivElement>((_, aboutMeRef) => {
  ...
  const myMergedRef = useMergedRef(aboutMeRef, ref);
  ...
  return (
    <>
      <Container p={{ base: 0, md: 16 }} size={containerSize} ref={myMergedRef}>
        <Grid>
